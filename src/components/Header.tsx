  ...
  return (
    <header className="w-full py-4 px-6 bg-white border-b border-gray-100 shadow-sm flex items-center justify-between">
      <div className="flex items-center space-x-2">
        <div className="flex items-center">
          <img 
            ...
            alt="worldAPI Logo" 
            className="h-24 w-auto" // Keeping the increased size
          />
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="h-9 w-9 rounded-full bg-worldapi-teal-100 text-worldapi-teal-600 flex items-center justify-center">
