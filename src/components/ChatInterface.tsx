  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-76px)] gap-4 p-4">
      <div className="md:w-1/4 w-full md:h-full overflow-y-auto">
        ...
        <div className="bg-worldapi-blue-50 border border-worldapi-blue-100 p-4 rounded-lg shadow-sm mt-4">
          ...
          <p className="text-xs text-worldapi-blue-700 mb-3 leading-relaxed">
            worldAPI provides a unified platform for financial institutions to
            access global payment networks through a single integration.
          </p>
          <Alert className="bg-worldapi-teal-50 border-worldapi-teal-100 text-worldapi-teal-800">
            <AlertDescription className="text-xs flex items-center">
              <Info size={14} className="mr-1 flex-shrink-0" />
              Your info is secured with bank-level encryption.
            </AlertDescription>
          </Alert>
        </div>
      </div>
